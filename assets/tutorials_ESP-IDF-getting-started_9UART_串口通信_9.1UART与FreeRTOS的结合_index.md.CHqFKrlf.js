import{_ as e,o as l,c as t,ae as n,j as s,a as p}from"./chunks/framework.Czhw_PXq.js";const i="/assets/image-0.Cr3ww_qT.png",r="/assets/image-1.K1xFtGmp.jpeg",_="/assets/image-2.Cz4Grg8Y.png",c="/assets/image-3.BFFgJUPI.png",o="/assets/image-4.CAA4bZrJ.png",d="/assets/image-5.Bls2h0HS.png",u="/assets/image-6.B9bH1EDP.png",T="/assets/image-7.Bqy8ZhXY.png",h="/assets/image-8.DXes5oVg.png",m="/assets/image-9.wYgWgLZK.png",g="/assets/image-10.D4QuXv1B.png",f="/assets/image-11.BuGL2XZe.png",R="/assets/image-12.CaSygFxy.png",U="/assets/image-13.BPfpATAF.png",A="/assets/image-14.Bcl01xo9.png",P="/assets/image-15.DhWqAST4.png",k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/ESP-IDF-getting-started/9UART_串口通信/9.1UART与FreeRTOS的结合/index.md","filePath":"tutorials/ESP-IDF-getting-started/9UART_串口通信/9.1UART与FreeRTOS的结合/index.md","lastUpdated":null}'),S={name:"tutorials/ESP-IDF-getting-started/9UART_串口通信/9.1UART与FreeRTOS的结合/index.md"};function I(v,a,O,b,q,E){return l(),t("div",null,[...a[0]||(a[0]=[n('<h2 id="📜-版权声明-apache-2-0" tabindex="-1">📜 版权声明 (Apache 2.0) <a class="header-anchor" href="#📜-版权声明-apache-2-0" aria-label="Permalink to &quot;📜 版权声明 (Apache 2.0)&quot;">​</a></h2><ul><li><strong>Copyright</strong>: 2026 MorkenMooooo</li><li><strong>Author</strong>: Mooooo (门主)</li><li><strong>平台</strong>: Bilibili &amp; Douyin &amp; 微信公众号 @ <strong>门主引擎 | Mooooo</strong></li><li><strong>联系</strong>: <a href="mailto:itsntcool@qq.com" target="_blank" rel="noreferrer">itsntcool@qq.com</a></li></ul><p>本项目采用 <strong>Apache License</strong>**, Version 2.0** 开源协议。 除非符合许可要求，否则不得使用本文件。 你可以在以下地址获取许可证副本： <a href="http://www.apache.org/licenses/LICENSE-2.0" target="_blank" rel="noreferrer">http://www.apache.org/licenses/LICENSE-2.0</a></p><p>除非适用法律要求或书面同意，否则本软件按“原样”分发，无任何明示或暗示的保证。</p><p>有关详细信息，请参阅许可证以了解特定语言管理的权限和限制。</p><h2 id="四、esp32-uart如何控制led灯" tabindex="-1">四、ESP32 UART如何控制LED灯？ <a class="header-anchor" href="#四、esp32-uart如何控制led灯" aria-label="Permalink to &quot;四、ESP32 UART如何控制LED灯？&quot;">​</a></h2><h3 id="_1、流程" tabindex="-1">1、流程 <a class="header-anchor" href="#_1、流程" aria-label="Permalink to &quot;1、流程&quot;">​</a></h3>',7),s("ol",null,[s("li",null,[p("配置GPIO结构体，并使能GPIO（LED灯的引脚） "),s("ol",null,[s("li",null,"gpio_config_t"),s("li",null,"gpio_config(&gpio_config_t)")])]),s("li",null,"安装驱动程序 - 为 UART 驱动程序分配 ESP32-S3 资源"),s("li",null,"设置通信参数 - 设置波特率、数据位、停止位等"),s("li",null,"设置通信管脚 - 分配连接设备的管脚"),s("li",null,"运行 UART 通信 - 发送/接收数据"),s("li",null,[p("检测 if MSB 第1位数据是0还是1，并输出LED灯引脚高低电平，进而控制LED灯亮灭 "),s("ol",null,[s("li",{"css-module":"...."},"if (data[0] == '1')"),s("li",{"css-module":"...."},"if (data[0] == '0')")])])],-1),n('<h2 id="五、什么是uart中断-freertos多任务-中断" tabindex="-1">五、什么是UART中断（FreeRTOS多任务+中断）？ <a class="header-anchor" href="#五、什么是uart中断-freertos多任务-中断" aria-label="Permalink to &quot;五、什么是UART中断（FreeRTOS多任务+中断）？&quot;">​</a></h2><h3 id="_5-1-先了解freertos是什么" tabindex="-1">5.1 先了解FreeRTOS是什么 <a class="header-anchor" href="#_5-1-先了解freertos是什么" aria-label="Permalink to &quot;5.1 先了解FreeRTOS是什么&quot;">​</a></h3><p>乐鑫官方网页ESP-IDF FreeRTOS介绍：<a href="https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos.html#freertos" target="_blank" rel="noreferrer">https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos.html#freertos</a></p><p>❗ Important</p><p>因为ESP-IDF是基于C语言和FreeRTOS进行开发的，所以ESP-IDF与STM32HAL库区别很大，ESP-IDF的void app_main(void)就是FreeRTOS的主任务程序。</p><p><img src="'+i+'" alt="人眼眨眼频率相比于CPU频率"></p><p><img src="'+r+'" alt="高铁并行"></p><p><img src="'+_+'" alt="串行与并行以及并发概念图"></p><h3 id="_5-2-为什么说esp-idf-freertos任务的有4种状态" tabindex="-1">5.2 为什么说ESP-IDF FreeRTOS任务的有4种状态？ <a class="header-anchor" href="#_5-2-为什么说esp-idf-freertos任务的有4种状态" aria-label="Permalink to &quot;5.2 为什么说ESP-IDF FreeRTOS任务的有4种状态？&quot;">​</a></h3><p>IDF FreeRTOS 中任务的结构与 Vanilla FreeRTOS 相同。具体而言，IDF FreeRTOS 任务：</p><ul><li>只能处于以下任一状态：运行中、就绪、阻塞或挂起。</li><li>任务函数通常为无限循环。</li><li>任务函数不应返回。</li></ul><h3 id="_5-3-esp-idf-freertos有哪些api参考" tabindex="-1">5.3 ESP-IDF FreeRTOS有哪些API参考？ <a class="header-anchor" href="#_5-3-esp-idf-freertos有哪些api参考" aria-label="Permalink to &quot;5.3 ESP-IDF FreeRTOS有哪些API参考？&quot;">​</a></h3><p><a href="https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id22" target="_blank" rel="noreferrer">https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id22</a></p><p><img src="'+c+`" alt="UART FreeRTOS 引入"></p><p>static inline BaseType_txTaskCreate(TaskFunction_t pxTaskCode, const char *const pcName, const configSTACK_DEPTH_TYPE usStackDepth, void *const pvParameters, UBaseType_t uxPriority, TaskHandle_t *const pxCreatedTask)</p><pre><code>示例代码：
</code></pre><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// Task to be created.</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="_5-4-如何实现uart与freertos结合的项目目标" tabindex="-1">5.4 如何实现UART与FreeRTOS结合的项目目标？ <a class="header-anchor" href="#_5-4-如何实现uart与freertos结合的项目目标" aria-label="Permalink to &quot;5.4 如何实现UART与FreeRTOS结合的项目目标？&quot;">​</a></h3><ol><li>绿色的灯每间隔100毫秒（Ms）闪烁一次，要求无限循环闪烁</li><li>红色的LED灯每间隔1.5秒（s）闪烁一次，也同样要求无限循环闪烁</li></ol><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>void app_main(void)</span></span>
<span class="line"><span>{</span></span>
...
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="_5-4-1-代码实现uart与freertos结合" tabindex="-1">5.4.1 代码实现UART与FreeRTOS结合 <a class="header-anchor" href="#_5-4-1-代码实现uart与freertos结合" aria-label="Permalink to &quot;5.4.1 代码实现UART与FreeRTOS结合&quot;">​</a></h4><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#include &lt;stdio.h&gt;</span></span>
...
<span class="line"><span>ESP_ERROR_CHECK(uart_enable_rx_intr(uart_num));</span></span></code></pre></div><p><img src="`+A+'" alt="ESP32-S3 UART中断控制LED点亮流程示意图"></p><h3 id="_6-5-uart中断流程代码步骤如何编写" tabindex="-1">6.5 UART中断流程代码步骤如何编写？ <a class="header-anchor" href="#_6-5-uart中断流程代码步骤如何编写" aria-label="Permalink to &quot;6.5 UART中断流程代码步骤如何编写？&quot;">​</a></h3><p><a href="https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id24" target="_blank" rel="noreferrer">https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id24</a></p><ol><li>创建Queue队列句柄，方便后期使用队列句柄传送中断消息给任务函数（中断 + 队列 + 任务的关系：（中断→队列→任务））</li><li>配置GPIO结构体，并使能GPIO（2颗LED灯）</li><li>配置UART及UART中断 <ol><li>安装驱动程序 - 为 UART 驱动程序分配 ESP32-S3 资源 <ol><li>步骤 1：修改uart_driver_install（创建队列，官方第一步）；</li></ol></li><li>设置通信参数 - 设置波特率、数据位、停止位等</li><li>设置通信管脚 - 分配连接设备的管脚</li><li>运行 UART 通信 - 发送/接收数据</li><li>使用中断 - 触发特定通信事件的中断 <ol><li>步骤 2：配置 UART 中断阈值（1 字节触发）；</li><li>步骤 3：启用 UART 接收中断；</li></ol></li></ol></li><li>创建事件处理任务（读取队列 + 控制 LED） <ol><li>创建FreeRTO Task任务，</li><li>创建Task任务的同时，编写并封装好中断服务函数</li><li>Task任务①为GPIO2号绿色LED灯每隔100毫秒闪烁一次</li><li>Task任务②为GPIO4号红色LED灯被UART中断控制（中断触发→队列传送中断被触发的消息→Task任务②唤醒并执行任务）</li></ol></li></ol><p><img src="'+P+`" alt="UART中断流程代码编写步骤"></p><h3 id="_6-6-代码实现uart中断-queue队列-非阻塞等待任务触发" tabindex="-1">6.6 代码实现UART中断（Queue队列+非阻塞等待任务触发） <a class="header-anchor" href="#_6-6-代码实现uart中断-queue队列-非阻塞等待任务触发" aria-label="Permalink to &quot;6.6 代码实现UART中断（Queue队列+非阻塞等待任务触发）&quot;">​</a></h3><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#include &lt;stdio.h&gt;</span></span>
<span class="line"><span>#include &quot;driver/gpio.h&quot;</span></span>
<span class="line"><span>#include &quot;freertos/FreeRTOS.h&quot;</span></span>
<span class="line"><span>#include &quot;freertos/task.h&quot;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><div class="language-plain vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#include &lt;stdio.h&gt;</span></span>
<span class="line"><span>#include &quot;freertos/FreeRTOS.h&quot;</span></span>
<span class="line"><span>#include &quot;freertos/task.h&quot;</span></span>
<span class="line"><span>#include &quot;driver/uart.h&quot;</span></span>
<span class="line"><span>#include &quot;driver/gpio.h&quot;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,71)])])}const D=e(S,[["render",I]]);export{k as __pageData,D as default};
