import{_ as e,o as l,c as i,ag as a,j as s,a as p}from"./chunks/framework.DXGyWiRo.js";const r="/assets/image-0.bdtZUhia.webp",t="/assets/image-1.Qtfx9dJ8.webp",c="/assets/image-2.CHl-gdCY.webp",b="/assets/image-3.DzpHdjr3.webp",u="/assets/image-4.DTgnegWo.webp",_="/assets/image-5.BrEvo6xY.webp",m="/assets/image-6.CjnEMlj9.webp",o="/assets/image-7.B8In7kcV.webp",d="/assets/image-8.DRAxmTls.webp",T="/assets/image-9.DHadZTZh.webp",h="/assets/image-10.CkAtIczI.webp",f="/assets/image-11.CnQi7uKU.webp",g="/assets/image-12.Cf0bCVeC.webp",R="/assets/image-13.DagusmFZ.webp",U="/assets/image-14.DEcXnhfX.webp",v="/assets/image-15.BN2Lmkl9.webp",L=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/ESP-IDF-getting-started/9 UART_串口通信/9.1UART与FreeRTOS的结合/index.md","filePath":"tutorials/ESP-IDF-getting-started/9 UART_串口通信/9.1UART与FreeRTOS的结合/index.md","lastUpdated":null}'),A={name:"tutorials/ESP-IDF-getting-started/9 UART_串口通信/9.1UART与FreeRTOS的结合/index.md"};function S(P,n,I,O,q,k){return l(),i("div",null,[...n[0]||(n[0]=[a('<div class="article-meta-card"><div class="meta-left"><div class="title-line"><span>📜 本文许可</span><a href="http://www.apache.org/licenses/LICENSE-2.0" target="_blank" class="license-badge">Apache 2.0</a></div><div class="info-line"><span>© 2026 MorkenMooooo · 作者：Mooooo</span><span>·</span><a href="https://space.bilibili.com/283444330" target="_blank">📺 Bilibili</a><a href="https://v.douyin.com/kcQ2Ofh6SiA/" target="_blank">🎵 Douyin</a><a href="/about/" target="_blank">💬 公众号</a><span>· 联系：<a href="mailto:itsntcool@qq.com">📧 邮箱</a></span></div></div><div class="meta-right"><a href="/products/" class="shop-btn"> 🚀 觉醒计划 · 配套硬件 </a></div></div><h2 id="四、esp32-uart如何控制led灯" tabindex="-1">四、ESP32 UART如何控制LED灯？ <a class="header-anchor" href="#四、esp32-uart如何控制led灯" aria-label="Permalink to &quot;四、ESP32 UART如何控制LED灯？&quot;">​</a></h2><h3 id="_1、流程" tabindex="-1">1、流程 <a class="header-anchor" href="#_1、流程" aria-label="Permalink to &quot;1、流程&quot;">​</a></h3>',3),s("ol",null,[s("li",null,[p("配置GPIO结构体，并使能GPIO（LED灯的引脚） "),s("ol",null,[s("li",null,"gpio_config_t"),s("li",null,"gpio_config(&gpio_config_t)")])]),s("li",null,"安装驱动程序 - 为 UART 驱动程序分配 ESP32-S3 资源"),s("li",null,"设置通信参数 - 设置波特率、数据位、停止位等"),s("li",null,"设置通信管脚 - 分配连接设备的管脚"),s("li",null,"运行 UART 通信 - 发送/接收数据"),s("li",null,[p("检测 if MSB 第1位数据是0还是1，并输出LED灯引脚高低电平，进而控制LED灯亮灭 "),s("ol",null,[s("li",{"css-module":"...."},"if (data[0] == '1')"),s("li",{"css-module":"...."},"if (data[0] == '0')")])])],-1),a('<h2 id="五、什么是uart中断-freertos多任务-中断" tabindex="-1">五、什么是UART中断（FreeRTOS多任务+中断）？ <a class="header-anchor" href="#五、什么是uart中断-freertos多任务-中断" aria-label="Permalink to &quot;五、什么是UART中断（FreeRTOS多任务+中断）？&quot;">​</a></h2><h3 id="_5-1-先了解freertos是什么" tabindex="-1">5.1 先了解FreeRTOS是什么 <a class="header-anchor" href="#_5-1-先了解freertos是什么" aria-label="Permalink to &quot;5.1 先了解FreeRTOS是什么&quot;">​</a></h3><p>乐鑫官方网页ESP-IDF FreeRTOS介绍：<a href="https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos.html#freertos" target="_blank" rel="noreferrer">https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos.html#freertos</a></p><p>❗ Important</p><p>因为ESP-IDF是基于C语言和FreeRTOS进行开发的，所以ESP-IDF与STM32HAL库区别很大，ESP-IDF的void app_main(void)就是FreeRTOS的主任务程序。</p><p><img src="'+r+'" alt="人眼眨眼频率相比于CPU频率"></p><p><img src="'+t+'" alt="高铁并行"></p><p><img src="'+c+'" alt="串行与并行以及并发概念图"></p><h3 id="_5-2-为什么说esp-idf-freertos任务的有4种状态" tabindex="-1">5.2 为什么说ESP-IDF FreeRTOS任务的有4种状态？ <a class="header-anchor" href="#_5-2-为什么说esp-idf-freertos任务的有4种状态" aria-label="Permalink to &quot;5.2 为什么说ESP-IDF FreeRTOS任务的有4种状态？&quot;">​</a></h3><p>IDF FreeRTOS 中任务的结构与 Vanilla FreeRTOS 相同。具体而言，IDF FreeRTOS 任务：</p><ul><li>只能处于以下任一状态：运行中、就绪、阻塞或挂起。</li><li>任务函数通常为无限循环。</li><li>任务函数不应返回。</li></ul><h3 id="_5-3-esp-idf-freertos有哪些api参考" tabindex="-1">5.3 ESP-IDF FreeRTOS有哪些API参考？ <a class="header-anchor" href="#_5-3-esp-idf-freertos有哪些api参考" aria-label="Permalink to &quot;5.3 ESP-IDF FreeRTOS有哪些API参考？&quot;">​</a></h3><p><a href="https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id22" target="_blank" rel="noreferrer">https://documentation.espressif.com/projects/esp-idf/zh_CN/latest/esp32s3/api-reference/system/freertos_idf.html#id22</a></p><p><img src="'+b+`" alt="UART FreeRTOS 引入"></p><p>static inline BaseType_txTaskCreate(TaskFunction_t pxTaskCode, const char *const pcName, const configSTACK_DEPTH_TYPE usStackDepth, void *const pvParameters, UBaseType_t uxPriority, TaskHandle_t *const pxCreatedTask)</p><pre><code>示例代码：
